...
export const Header: React.FC = () => {
  ...
  return (
    <header className="sticky top-0 z-100 bg-[rgba(7,10,16,0.85)] backdrop-blur-xl border-b border-[rgba(255,255,255,0.07)] px-6 h-[88px] flex items-center justify-between">
      <div className="flex items-center gap-3">
        <div className="logo-dot-header">
          <div className="logo-dot-inner"></div>
        </div>
         <span className="text-[17px] font-bold text-white font-syne tracking-[-0.3px] leading-none">Polkadot Revive Playground</span>
