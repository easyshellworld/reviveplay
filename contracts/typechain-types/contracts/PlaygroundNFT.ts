...
export interface PlaygroundNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface PlaygroundNFT extends BaseContract {
  connect(runner?: ContractRunner | null): PlaygroundNFT;
  waitForDeployment(): Promise<this>;

  interface: PlaygroundNFTInterface;
